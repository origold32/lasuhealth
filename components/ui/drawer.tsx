  ...
  <DrawerPortal>
    ...
    <DrawerPrimitive.Content
      ...
      className={cn(
        ...
        "bg-background flex flex-col h-full w-full right-auto left-auto bottom-0 fixed z-50",
    ...
    >
      ...
      {/* <div className="my-auto w-2 h-[100px] rounded-full bg-muted absolute inset-y-0 -ml-3" /> */}
      {children}
    </DrawerPrimitive.Content>
  </DrawerPortal>
));
